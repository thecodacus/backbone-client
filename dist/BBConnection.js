...
var BBConnection = /** @class */ (function () {
    function BBConnection(socket, token) {
    ...
    BBConnection.prototype.runRequest = function (request, connetable) {
        var _this = this;
    ...
    BBConnection.prototype._setupChannel = function (channelId) {
        var _this = this;
    ...
    BBConnection.prototype.createChangeFeed = function (source, change) {
        var _this = this;
    ...
    BBConnection.prototype.close = function () {
        this.conn.cursor.complete();
        this.closed = true;
    };
    BBConnection.prototype.setToken = function (token) {
        this.token = token;
    };
    BBConnection.prototype.isAuthenticated = function () {
...
export { BBConnection };
//# sourceMappingURL=BBConnection.js.map